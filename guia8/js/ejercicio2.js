    function inputCorreoOnly(e){
        ...
        if(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3,4})+$/.test(e)){
            ...
            document.getElementById('msgerror1').style.height = "32px";
            document.getElementById('msgerror1').style.paddingTop = "4px";
            document.getElementById('msgerror1').style.paddingLeft = "9px";
            document.getElementById('msgerror1').style.width = "40%";
            document.getElementById('msgerror1').innerHTML = "Sólo se aceptan caracteres alfabéticos y signos gramaticales";
    ...
    function inputLetterOnly(e){
        var evt = e ? e : event;
        var keyCode = (evt.which) ? evt.which : evt.keyCode;
        document.getElementById('msgerror').style.display = "none";
        //alert("Código de tecla presionada " + keyCode);
        if((keyCode>=34 && keyCode<=71)){
            //Any other input? Prevent the default response:
            ...
            document.getElementById('msgerror').style.width = "40%";
            document.getElementById('msgerror').innerHTML = "Sólo se aceptan caracteres alfabéticos";
            if(evt.preventDefault) evt.preventDefault();
            evt.returnValue = false;
            return false;
        }
...
function init() {
addEventHandler(self.document.entradas.nombre, 'keypress', inputLetterOnly);
addEventHandler(self.document.entradas.correo, 'keypress', inputCorreoOnly);
